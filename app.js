...
vk.setOptions({ token: '62a4d49f81c6e7fc6ffdec37ea9e52863b81917a9afae32e91bca03335381c7d47ddff9e2060d49795b47', pollingGroupId: 151516167 });
...
updates.on('message', async (message) => {
	...
	console.log(`Игрок: ${message.user.uid} : ${message.text}`)
});
